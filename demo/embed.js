...
var innerHorizontal = tosiProduct(
...
var outerEngine = tosiProduct(
  ...
  tosiProductSection(
    ...
    div2(
      ...
      div2({ class: "nested-frame" }, innerHorizontal)
    )
  ),
  tosiProductSection(
    { scroll: 100 },
    div2(
      ...
      h2("Outer Section C"),
      p2("Engine continues vertically after the nested region."),
      span({ class: "marker" }, "outer / vertical")
    )
  )
);
