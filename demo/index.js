...
var g0 = (i2, l4, s2, o2) => {
  ...
  for (let y3 of [...h2]) {
    let { fill: e2, stroke: x3, strokeWidth: n3, strokeLinecap: p, strokeLinejoin: d3 } = y3.style;
    if (e2)
      y3.setAttribute("fill", F.fromCss(e2).html);
    if (x3)
      y3.setAttribute("stroke", F.fromCss(x3).html);
    if (n3)
      y3.setAttribute("strokeWidth", n3);
    if (p)
...
class v0 extends m {
  ...
  loadUI = async (i2) => {
    ...
    if (o2)
      ...
      return null;
    let x3 = s2.getChildren()[0], n3 = x3.children.reduce((p, d3) => {
...
class d22 extends m {
  ...
  render() {
    ...
    s2.forEach((x3) => {
      x3.role = "group";
    }), e2.style.gridTemplateColumns = `${100 / this.maxVisibleItems / (1 + this.lastPage)}% `.repeat(s2.length).trim(), e2.style.width = (1 + this.lastPage) * 100 + "%", h2.textContent = "", h2.append(...s2.map((x3, n3) => p2({ title: `item ${n3 + 1}`, class: "dot" }))), this.indicateCurrent(), h2.style.display = i2 && o2 > 0 ? "" : "none", r2.hidden = y3.hidden = !(l4 && o2 > 0);
  }
}
...
var G2 = (i2, l4, s2 = "move") => {
  if (!i2.type.startsWith("touch")) {
    ...
    let h2 = i2.changedTouches[0], r2 = h2.identifier, y3 = h2.clientX, e2 = h2.clientY, x3 = i2.target, n3 = 0, p = 0, d3 = (C2) => {
      let k2 = [...C2.touches].find((w3) => w3.identifier === r2);
      if (k2 !== undefined)
        n3 = k2.clientX - y3, p = k2.clientY - e2;
      if (C2.type === "touchmove")
        C2.stopPropagation(), C2.preventDefault();
      if (l4(n3, p, C2) === true || k2 === undefined)
...
var x5 = (i2, l4, s2, o2, h2, r2 = false) => {
  ...
  i2.drag = r2;
  let { left: y3, top: e2, width: x3, height: n3 } = l4.getBoundingClientRect(), p = y3 + x3 * 0.5, d3 = e2 + n3 * 0.5, C2 = window.innerWidth, k2 = window.innerHeight;
  if (s2 === "side")
  ...
  if (i2.style.top = i2.style.left = i2.style.right = i2.style.bottom = i2.style.transform = "", s2.length === 2) {
    ...
    switch (O2) {
      case "n":
        i2.style.bottom = (k2 - e2 - n3).toFixed(2) + "px";
        break;
      case "e":
    ...
    i2.style.top = (e2 + n3).toFixed(2) + "px", i2.style.left = p.toFixed(2) + "px", i2.style.transform = "translateX(-50%)";
  else if (s2 === "e")
...
var H5 = (i2, l4) => {
  let s2 = i2.checked && i2.checked() && "check" || false, o2 = i2?.icon || s2 || K3(" ");
  if (typeof o2 === "string")
    o2 = t3[o2]();
  let h2 = l4.role === "listbox" ? "option" : "menuitem", r2;
  if (typeof i2?.action === "string")
    r2 = B5({ class: "xin-menu-item", role: h2, href: i2.action }, o2, l4.localized ? K3(z2(i2.caption)) : K3(i2.caption), K3(i2.shortcut || " "));
  else
    r2 = k2({ class: "xin-menu-item", role: h2, onClick: i2.action }, o2, l4.localized ? K3(z2(i2.caption)) : K3(i2.caption), K3(i2.shortcut || " "));
...
var j5 = (i2, l4) => {
  ...
  } }, o2, l4.localized ? K3(z2(i2.caption)) : K3(i2.caption), t3.chevronRight({ style: { justifySelf: "flex-end" } }));
  return h2;
};
var A5 = (i2, l4) => {
  if (i2 === null)
...
class H2 extends m {
  ...
  updateSelection = (i2) => {
    ...
    if (this.multiple && h2.shiftKey && y3.length > 0 && this.rangeStart !== o2) {
      let e2 = this.rangeStart === undefined || this.rangeStart[this.selectedKey] === true, [x3, n3] = [this.rangeStart !== undefined ? y3.indexOf(this.rangeStart) : 0, y3.indexOf(o2)].sort((p, d3) => p - d3);
      if (x3 > -1)
        for (let p = x3;p <= n3; p++) {
          let d3 = y3[p];
      ...
      let e2 = y3.indexOf(o2), x3 = y3[e2 + 1], n3 = e2 > 0 ? y3[e2 - 1] : undefined;
...
async function b22(i3) {
  let { html: l4, css: s2, js: o2, context: h2, transform: r2, exampleElement: y3, styleElement: e2, widgetsElement: x3, onError: n3 } = i3, p = hi({ class: "preview" });
  ...
  let C3 = { preview: p, ...h2 };
  try {
    let k3 = C1(o2, Object.keys(h2)), w3 = r2(k3, { transforms: ["typescript"] }).code, O3 = Object.keys(C3).map((F3) => F3.replace(/-/g, "")), R2 = Object.values(C3);
...
async function G22(i3) {
  let { html: l4, css: s2, js: o2, context: h2, transform: r2, exampleElement: y3, widgetsElement: e2, onError: x3 } = i3, n3 = y3.querySelector("iframe.preview-iframe");
  if (!n3) {
    ...
    if (w3)
      ...
      y3.insertBefore(n3, e2);
  }
  let p = n3.contentDocument;
  if (!p)
...
<body>
  ...
  try {
    let w3 = C1(o2, Object.keys(h2)), O3 = r2(w3, { transforms: ["typescript"] }).code, R2 = d3.eval("(async () => {}).constructor"), H = Object.keys(k3).map((v1) => v1.replace(/-/g, "")), F3 = Object.values(k3);
...
function U2(i3, l4, s2, o2) {
  ...
  for (let r2 = 0;r2 < h2.length; r2 += 1) {
    ...
    y3[0].block.parentElement.insertBefore(e2, y3[0].block), y3.forEach((n3) => {
      switch (n3.language) {
        case "js":
          e2.js = n3.code;
          break;
    ...
    try {
      ...
      if (e2 instanceof Promise) {
        let x3 = ti(e2, l6, y3).then(() => {
          ...
          i3.push({ name: y3, passed: false, error: n3.message });
        });
        o2.push(x3);
      } else
        i3.push({ name: y3, passed: true });
...
async function X22(i3, l6, s2, o2) {
  ...
  try {
    let e2 = C1(i3, Object.keys(s2)), x3 = o2(e2, { transforms: ["typescript"] }).code, n3 = Object.keys(y3).map((C3) => C3.replace(/-/g, "")), p = Object.values(y3);
    await new U1(...n3, x3)(...p);
  } catch (e2) {
...
class m3 extends m {
  ...
  set locked(i3) {
    let { bottom: l6, right: s2 } = i3, { left: o3, top: h2 } = i3, r2 = this.parentElement, y3 = r2.offsetLeft, e2 = r2.offsetTop, x3 = r2.offsetWidth, n3 = r2.offsetHeight, p = r2.offsetParent.offsetWidth - y3 - x3, d3 = r2.offsetParent.offsetHeight - e2 - n3;
  ...
  adjustRotation = (i3) => {
    ...
    G2(i3, (o3, h2, r2) => {
      let { clientX: y3, clientY: e2 } = r2, x3 = y3 - l6.x, n3 = e2 - l6.y, p = n3 > 0 ? 90 : -90;
      if (x3 !== 0)
        p = Math.atan2(n3, x3) * 180 / Math.PI;
  ...
  connectedCallback() {
    super.connectedCallback();
    let { left: i3, right: l6, top: s2, bottom: o3, lockLeft: h2, lockRight: r2, lockTop: y3, lockBottom: e2, move: x3, resize: n3, rotate: p } = this.parts, d3 = { passive: true };
...
class C4 extends m {
  ...
  buildFilter = () => {
    ...
    let n3 = r2.needsValue !== false ? ` "${s2.value}"` : "", p = `${p4(i3)} ${p4(l6)}${n3}`;
...
class M4 extends m {
  ...
  render() {
    ...
    let e2 = K1(this.year, this.month, 1), x3 = new Date(e2.valueOf() - (7 + e2.getDay() - this.weekStart) % 7 * X1), n3 = this.month === 12 ? 1 : this.month + 1, p = new Date(K1(this.year + (this.month === 12 ? 1 : 0), n3, 1).valueOf() - X1), d3 = new Date(p.valueOf() + (this.weekStart * 2 + 5 + this.endDay - p.getDay()) % 7 * X1), C3 = ll.map((H) => new Date(x3.valueOf() + H * X1).toString().split(" ")[0]);
    this.days = [];
...
class k1 extends m {
  ...
  static post(i3) {
    ...
    let n3 = e2 || rl[o3], p = r2 || o3 === "progress" ? T.progress() : {}, d3 = () => {
      if (h3)
        h3();
      k1.removeNote(w3);
    }, C3 = y3 instanceof SVGElement ? y3 : y3 ? t3[y3]({ class: "icon" }) : t3.info({ class: "icon" }), k3 = o3 === "error" || o3 === "warn", w3 = l0({ class: `note ${o3}`, role: k3 ? "alert" : "status", ariaLive: k3 ? "assertive" : "polite", style: { _notificationAccentColor: n3 } }, C3, l0({ class: "message" }, l0(l6), p), hl({ class: "close", title: "close", ariaLabel: "Close notification", apply(O3) {
...
var { div: div2, h1: h12, h2: h22, p, pre, code, span: span2, video } = T;
var ease = (t5) => t5 < 0.5 ? 2 * t5 * t5 : -1 + (4 - 2 * t5) * t5;
var overlay = (range, text, options = {}) => tosiInterpolator({ "data-scroll-animate": "interpolator", "data-scroll-range": range }, tosiWaypoint({
  progress: 0,
  ...
  progress: 1,
  style: { opacity: 0, transform: "translateY(-20px)" }
}), div2({ class: "overlay", ...options }, h12({ class: "hero-text" }, text)));
var featureIntro = (title, description, codeText, bg = "#0a0a0a") => tosiProductSection({ scroll: 250, style: { background: bg } }, tosiInterpolator({ "data-scroll-animate": true, easing: "ease-in-out" }, tosiWaypoint({
  progress: 0,
  ...
  progress: 1,
  style: { opacity: 0, transform: "translateY(-60px)" }
}), div2({ class: "feature-text", style: { flexDirection: "column" } }, h22(title), p(description), ...codeText ? [tosiCode({ language: "html" }, codeText)] : [])));
...
}), div2({ class: "hero" }, h12("tosijs-product"), p("Build scrolling pages that tell your product's story. With HTML.")))), featureIntro("<tosi-interpolator>", "Scrolling is progress. Orchestrate layers with declarative waypoints — opacity, transforms, any CSS property.", `<tosi-interpolator data-scroll-animate>
...
</tosi-interpolator>`, "#050510"), tosiProductSection({ scroll: 300, style: { background: "#0a0a0a" } }, tosiInterpolator({ "data-scroll-range": "0,0.5", easing: "ease-in-out" }, tosiWaypoint({
  progress: 0,
...
}, h22("Scroll Ranges"), p("Constrain animations to any portion of a section's scroll."))), tosiInterpolator({ "data-scroll-range": "0.5,1", easing: "ease-in-out" }, tosiWaypoint({
  progress: 0,
  style: { opacity: 0, transform: "translateX(80px)" }
}), tosiWaypoint({
  progress: 0.5,
...
}, h22("Layer by Layer"), p("Choreograph multiple elements, each with its own timing.")))), featureIntro("Video Scrubbing", `Scrub any video frame-by-frame via scroll position. Just add data-scroll-animate="currentTime" — you'll want a fast server or CDN.`, `<video src="clip.mp4" data-scroll-animate="currentTime" muted playsinline></video>`), tosiProductSection({ scroll: 300, style: { backgroundColor: "#000" } }, video({
  src: "demo/assets/agent-owl.mp4",
  "data-scroll-animate": "currentTime",
  muted: true,
  playsinline: true,
  preload: "auto"
}), overlay("0.1, 0.5", "Scrub any video. Frame by frame.")), featureIntro("Filmstrip Mosaic", "Convert video into a single mosaic image. No video decode, instant seeking, works everywhere. Use the tosi-mosaic CLI to generate.", `<tosi-filmstrip
  src="clip_10x10_100.jpg"
  cols="10" rows="10" total="100"
  data-scroll-animate
></tosi-filmstrip>`), tosiProductSection({ scroll: 300, style: { backgroundColor: "#000" } }, tosiFilmstrip({
  src: "demo/assets/agent-owl_10x10_100.jpg",
  cols: 10,
  rows: 10,
  total: 100,
  "data-scroll-animate": "true"
}), overlay("0.1, 0.9", "100 frames. One image. Zero stutter.")), featureIntro("Mapbox Integration", "Travel the world with scroll-linked map navigation. Zoom out, pan across continents, zoom back in.", `<tosi-scroll-mapper>
  <tosi-map token="pk.ey..."
    coords="37.46,-122.43,12"
    map-style="mapbox://styles/mapbox/dark-v11">
  </tosi-map>
</tosi-scroll-mapper>`), tosiProductSection({ scroll: 500, style: { backgroundColor: "#fff" } }, tosiScrollMapper({
...
})), overlay("0, 0.2", "Half Moon Bay"), overlay("0.8, 1.0", "Oulu")), featureIntro("3D Scenes", "Animate BabylonJS scenes with scroll-driven camera waypoints. Load any GLB/glTF model.", `<tosi-scroll-camera data-scroll-animate easing="ease-in-out">
  <tosi-waypoint progress="0" alpha="-1.57" radius="110"></tosi-waypoint>
  <tosi-waypoint progress="1" alpha="1.57" radius="76"></tosi-waypoint>
</tosi-scroll-camera>`), tosiProductSection({ scroll: 400, style: { backgroundColor: "#111" } }, overlay("0, 0.5", "MacBook Neo."), overlay("0.5, 1.0", "Every angle. Pure elegance."), a3({
...
}), tosiScrollCamera({ "data-scroll-animate": true, easing: "ease-in-out" }, tosiWaypoint({ progress: 0, alpha: -1.57, beta: 1.2, radius: 110 }), tosiWaypoint({ progress: 0.5, alpha: 0, beta: 1, radius: 70 }), tosiWaypoint({ progress: 1, alpha: 1.57, beta: 1.55, radius: 76 }))), featureIntro("Lottie Animations", "Scrub Lottie/Bodymovin animations with scroll progress. Frame-perfect control over vector animations.", `<tosi-lottie
  src="animation.json"
  data-scroll-animate="lottie"
></tosi-lottie>`), tosiProductSection({
  scroll: 200,
...
}, tosiInterpolator({ "data-scroll-animate": true, easing: "ease-in-out" }, tosiWaypoint({
  progress: 0,
  ...
  progress: 1,
  style: { opacity: 0, transform: "translateY(-40px)" }
}), div2({ class: "feature-text", style: { flexDirection: "column" } }, h22("One Script Tag"), p("The IIFE build includes tosijs, tosijs-ui, and tosijs-product. Load it from a CDN and start building."), tosiCode({ language: "html" }, `<script src="https://cdn.jsdelivr.net/npm/tosijs-product/dist/index.js"></script>`)))), div2({ style: { padding: "4em 1em", background: "#111", textAlign: "center" } }, h22({
  style: { fontSize: "clamp(1.5rem, 4vw, 2.5rem)", margin: "0 0 0.5em" }
}, "Nested Scroll Containers"), p({
...
].map(([name, desc, bg, color], i3, arr) => tosiProductSection({ scroll: 200, style: { background: bg } }, tosiInterpolator({ "data-scroll-animate": true }, tosiWaypoint({
  progress: 0,
  style: {
    opacity: i3 === 0 ? 1 : 0,
    transform: i3 === 0 ? "translateY(0px)" : "translateY(40px)"
  }
}), tosiWaypoint({
  progress: 0.3,
  style: { opacity: 1, transform: "translateY(0px)" }
  ...
  progress: 1,
  style: {
    opacity: i3 === arr.length - 1 ? 1 : 0,
    transform: i3 === arr.length - 1 ? "translateY(0px)" : "translateY(-40px)"
  }
}), div2({ class: "feature-text", style: { flexDirection: "column" } }, h22({ style: { color } }, `<${name}>`), p(desc)))))))), div2({
  ...
  style: {
    opacity: i3 === 0 ? 1 : 0,
    transform: i3 === 0 ? "translateX(0px)" : "translateX(60px)"
  }
}), tosiWaypoint({
  progress: 0.3,
  style: { opacity: 1, transform: "translateX(0px)" }
  ...
  style: {
    opacity: i3 === arr.length - 1 ? 1 : 0,
    transform: i3 === arr.length - 1 ? "translateX(0px)" : "translateX(-60px)"
  }
}), div2({
  class: "feature-text",
  style: { flexDirection: "column", whiteSpace: "normal" }
}, h22({ style: { color } }, name), p(desc)))))))), div2({
  style: {
    textAlign: "center",
    padding: "4em 1em",
    background: "#000",
