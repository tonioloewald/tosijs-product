...
function cM(E, M, L, f) {
  ...
  if (f === hE) return E.splice(H, 1), h.delete(E), Symbol("deleted");
    ...
    else if (M !== "" && V(f, M) + "" === L + "") E.push(f), (H = E.length - 1);
    else throw Error(`byIdPath insert failed at [${M}=${L}]`);
  return E[H];
}
function xM(E) {
  if (!Array.isArray(E)) throw dE("setByPath failed: expected array, found", E);
}
function yM(E) {
...
function l(E, M, L) {
  let f = E;
  if (M === "") throw Error("setByPath cannot be used to set the root object");
  let H = mM(M);
  while (f != null && H.length > 0) {
    ...
    if (typeof $ === "string") {
      ...
      while ($.length > 0) {
        let J = $.shift();
        if ($.length > 0 || H.length > 0) f = yL(f, J, $.length > 0 ? {} : []);
        else {
          if (L !== hE) {
...
var N = (E) => {
  ...
  if (L !== null) {
    ...
    if (Q != null) {
      let Z = PL(f, J, Q, $);
      for (let Y of Z) if (YE.find((F) => Y.startsWith(F)) == null) YE.push(Y);
    }
  }
};
var i = (E, M) => {
...
class X {
  ...
  hslCached;
  get _hsl() {
    if (this.hslCached == null) this.hslCached = new oM(this.r, this.g, this.b);
    return this.hslCached;
  }
  get hsl() {
    let { h: E, s: M, l: L } = this._hsl;
    return `hsl(${E.toFixed(0)}deg ${(M * 100).toFixed(0)}% ${(L * 100).toFixed(
      0
    )}%)`;
  }
  get hsla() {
...
class FL {
  ...
  constructor(E, M, L = {}) {
    ...
    let f = L.virtual?.itemsPerRow ?? 1,
      H = Array.from(E.children).find((Q) => Q instanceof HTMLTemplateElement),
      $ = null;
    if (H != null) {
      let Q = f;
  ...
  _updateInterpolatedBuffers(E) {
    ...
    if (this.listTop != null && this.listBottom != null)
      (this.listTop.style.height = String(F) + "px"),
        (this.listBottom.style.height = String(Math.max(0, $ - F - Q)) + "px");
  }
}
var DE = (E, M, L) => {
  let f = E[QE];
...
var WM = (E, M) => {
  ...
  for (let f of L) {
    ...
    if (Q != null) {
      if (J.startsWith("^")) {
        let Z = GM(E);
        if (Z != null && Z[m] != null) J = f.path = `${Z[m]}${J.substring(1)}`;
        else {
  ...
  hydrate() {
    if (!this._hydrated) {
      ...
      let E = typeof this.content !== "function",
        M = typeof this.content === "function" ? this.content(I) : this.content;
      if (Array.isArray(M)) {
        let $ = {};
        M = M.filter((J) => {
          if (
...
`,
            ...
            if (
              ((h2 = Z),
              this.options.pedantic
                ? ((h2 = h2.replace(this.rules.other.listReplaceNesting, "  ")),
                  (A = h2))
...
`),
      ...
      for (let p2 = 0; p2 < i2.items.length; p2++)
        if (
          ...
          (i2.items[p2].tokens = this.lexer.blockTokens(i2.items[p2].text, [])),
          !i2.loose)
        ) {
      ...
      if (i2.loose)
        for (let p2 = 0; p2 < i2.items.length; p2++) i2.items[p2].loose = true;
      return i2;
    }
  }
  html(e2) {
...
var B = class {
          ...
          n2.extensions &&
            (n2.extensions.forEach((i2) => {
              ...
              if ("tokenizer" in i2) {
                ...
                let s2 = t2[i2.level];
                s2 ? s2.unshift(i2.tokenizer) : (t2[i2.level] = [i2.tokenizer]),
                  i2.start &&
                    (i2.level === "block"
                      ? t2.startBlock
  ...
  parseMarkdown(e2) {
    return (n2, r2) => {
      ...
      if (
        (s2.hooks && ((s2.hooks.options = s2), (s2.hooks.block = e2)), s2.async)
      )
        return (async () => {
...
var g0 = (i2, l4, s2, o2) => {
  ...
  for (let y2 of [...h2]) {
    ...
    if (n3) y2.setAttribute("strokeWidth", n3);
...
class d2 extends u {
  ...
  static styleSpec = {
    ":host": { display: "flex", flexDirection: "column", position: "relative" },
    ...
    ":host::part(scroller)": { overflow: "auto hidden", position: "relative" },
  ...
  render() {
    ...
    s2.forEach((x3) => {
      ...
      (h2.textContent = ""),
      h2.append(
        ...s2.map((x3, n3) => p2({ title: `item ${n3 + 1}`, class: "dot" }))
      ),
  ...
  if (!i2.type.startsWith("touch")) {
    ...
    let h2 = i2.changedTouches[0],
      ...
      d3 = (C3) => {
        ...
        if (k3 !== undefined) (n3 = k3.clientX - y2), (p3 = k3.clientY - e2);
        if (C3.type === "touchmove") C3.stopPropagation(), C3.preventDefault();
...
var x5 = (i2, l4, s2, o2, h2, r2 = false) => {
  ...
  i2.drag = r2;
  let { left: y2, top: e2, width: x3, height: n3 } = l4.getBoundingClientRect(),
    p3 = y2 + x3 * 0.5,
    d3 = e2 + n3 * 0.5,
...
hL("xin-menu-helper", {
  ...
  ".xin-menu-item, .xin-menu-item > span": { color: kE.menuItemColor("#222") },
  ...
  resizeColumn = (i2) => {
    ...
    if (l4 !== undefined) {
      ...
      G2(
        ...
        (r2, y2, e2) => {
          if (
            (o2 ? [...e2.touches].find((p3) => p3.identifier === h2) : true) ===
            undefined
          )
            return true;
          let n3 = s2 + r2;
          if (
            ((l4.width = n3 > this.minColumnWidth ? n3 : this.minColumnWidth),
        ...
        H1(
          {
            ...
            bindList: { value: this.rowData.pinnedTop, virtual: this.virtual },
          },
          this.rowTemplate(l4)
        )
      );
...
class i2 {
  ...
  send(i3) {
    ...
    if ((J22(this.storageKey, l4), this.channel)) this.channel.postMessage(l4);
  }
  sendClose() {
    let i3 = {
    ...
    if ((J22(this.storageKey, i3), this.channel)) this.channel.postMessage(i3);
  }
}
var { div: hi } = I;
function ri(i3, l4) {
...
async function b22(i3) {
  ...
  try {
    let k3 = C1(o2, Object.keys(h2)),
      ...
      O = Object.keys(C3).map((F3) => F3.replace(/-/g, "")),
      R2 = Object.values(C3);
    await new U1(...O, w3)(...R2);
  } catch (k3) {
    if ((console.error(k3), n3)) n3(k3);
...
async function G22(i3) {
  let {
    ...
    n3 = y2.querySelector("iframe.preview-iframe");
  if (!n3) {
    (n3 = document.createElement("iframe")),
      (n3.className = "preview-iframe"),
      (n3.style.cssText = "width: 100%; height: 100%; border: none;");
    let w3 = y2.querySelector(".preview");
    if (w3) w3.replaceWith(n3);
    else y2.insertBefore(n3, e2);
  }
...
async function X22(i3, l6, s2, o2) {
  ...
  try {
    let e2 = C1(i3, Object.keys(s2)),
      ...
      n3 = Object.keys(y2).map((C3) => C3.replace(/-/g, "")),
      p3 = Object.values(y2);
...
class m3 extends u {
  ...
  static styleSpec = {
    ...
    ':host > [part="rotate"]': { transform: `translateY(${fM.handleSize_50})` },
  ...
  set locked(i3) {
    let { bottom: l6, right: s2 } = i3,
      ...
      d3 = r2.offsetParent.offsetHeight - e2 - n3;
    if (
  ...
  adjustPosition = (i3) => {
    ...
    G2(i3, (e2, x3, n3) => {
      ...
      if (n3.type === "mouseup") return this.triggerChange(), true;
    });
  };
  resize = (i3) => {
    ...
    G2(i3, (r2, y2, e2) => {
      let x3 = o3 - r2,
        n3 = h2 - y2;
      if (
        (([x3, n3] = m3.snappedCoords(e2, [x3, n3])),
        (l6.style.right = x3 + "px"),
        (l6.style.bottom = n3 + "px"),
        e2.type === "mouseup")
      )
  ...
  adjustRotation = (i3) => {
    ...
    G2(i3, (o3, h2, r2) => {
      let { clientX: y2, clientY: e2 } = r2,
        ...
        n3 = e2 - l6.y,
        p3 = n3 > 0 ? 90 : -90;
      if (x3 !== 0) p3 = (Math.atan2(n3, x3) * 180) / Math.PI;
  ...
  buildFilter = () => {
    ...
    if (e2 !== "*") x3 = o3 ? (d3) => !y2(d3[e2]) : (d3) => y2(d3[e2]);
      ...
      x3 = o3
        ...
        : (d3) => Object.values(d3).find((C3) => y2(C3)) !== undefined;
    let n3 = r2.needsValue !== false ? ` "${s2.value}"` : "",
      p3 = `${p4(i3)} ${p4(l6)}${n3}`;
...
var Ri = {
  ...
  ":host .hidden": { position: "absolute", pointerEvents: "none", opacity: 0 },
};
        ...
        console.log(
          ...
          this._map.on("moveend", () => {
            let r2 = this._map.getCenter(),
              ...
              e2 = `${r2.lat.toFixed(6)},${r2.lng.toFixed(6)},${y2.toFixed(1)}`;
            if (e2 !== this.value) {
...
class M4 extends u {
  ...
  content = () => [
    S2(
      { part: "header" },
      T22({ part: "previous", onClick: this.previousMonth }, t3.chevronLeft()),
      h2({ style: { flex: "1" } }),
  ...
  render() {
    ...
    let e2 = K1(this.year, this.month, 1),
      ...
      n3 = this.month === 12 ? 1 : this.month + 1,
      p3 = new Date(
        K1(this.year + (this.month === 12 ? 1 : 0), n3, 1).valueOf() - X1
      ),
      d3 = new Date(
        p3.valueOf() +
    ...
    for (let H = x3.valueOf(); H <= d3.valueOf(); H += X1) {
      let F3 = new Date(H),
        P3 = F3.toISOString().split("T")[0];
      this.days.push({
        date: F3,
        selected: false,
        inMonth: F3.getMonth() + 1 === this.month,
        isToday: P3 === k3,
        isWeekend: F3.getDay() % 6 === 0,
    ...
    l6.append(
      ...this.days.map((H) => {
        let F3 = ["date"];
        if (H.inMonth) F3.push("in-month");
        if (H.isToday) F3.push("today");
        let P3 = H.date.toISOString().split("T")[0];
        if (this.checkDay(P3)) F3.push("checked");
        if ((F3.push(H.isWeekend ? "weekend" : "weekday"), this.range)) {
          if (O === P3) F3.push("range-end");
          if (R2 === P3) F3.push("range-start");
        }
        let v1 = h2(
          {
            class: F3.join(" "),
  ...
  static post(i3) {
      ...
      w3 = l0(
        {
          ...
          style: { _notificationAccentColor: n3 },
        },
        C3,
    ...
    if (
      ...
      let O = setInterval(() => {
        ...
        let R2 = r2();
        if (((p3.value = R2), R2 >= 100)) k1.removeNote(w3);
      }, 1000);
    }
    if (s2 > 0)
      setTimeout(() => {
...
class r0 extends u {
  ...
  static styleSpec = {
    ...
    ":host::part(container)": { position: "relative", display: "inline-block" },
  ...
  update = (i3) => {
    ...
    let { empty: l6 } = this.parts,
      s2 =
        i3 instanceof MouseEvent ? i3.pageX - l6.getBoundingClientRect().x : 0,
      o3 = Math.min(
        Math.max(
          this.min,
          Math.round(
...
class N1 extends u {
  ...
  handleChange = () => {
    ...
    if (this.multiple) {
      ...
      if (!s2) this.value = "";
      else if (s2.value) l6.setAttribute("hidden", ""), (this.value = s2.value);
      else
...
class W1 extends u {
  ...
  render() {
    ...
    else l6.toggleAttribute("hidden", true), s2.toggleAttribute("hidden", true);
    i3.textContent = "";
...
var pageHeader = header(
  { class: "page-header" },
  div2({ class: "brand" }, "tosijs-product"),
  nav(
    a5({ href: "https://github.com/tonioloewald/tosijs-product" }, "GitHub"),
    a5({ href: "https://product.tosijs.net" }, "Docs"),
    a5({ href: "https://www.npmjs.com/package/tosijs-product" }, "npm"),
    a5({ href: "https://tosijs.net" }, "tosijs"),
    a5({ href: "https://ui.tosijs.net" }, "tosijs-ui"),
    a5({ href: "https://3d.tosijs.net" }, "tosijs-3d")
  )
);
var stickyProgressLabel = span({ class: "progress" }, "0%");
var stickyHeader = tosiProductHeader(
  { threshold: 80 },
  div2(
    { class: "sticky-bar" },
    div2({ class: "brand" }, "tosijs-product"),
...
var mediaOverlay = (range, title, subtitle) =>
  tosiInterpolator(
    {
...
var app = tosiProduct(
  tosiProductSection(
    ...
    div2(
      ...
      p3("Build cinematic product pages with HTML."),
      div2({ class: "hero-pill" }, "scroll")
    )
  ),
  md(`## What is tosijs-product?
  ...
  tosiProductSection(
    ...
    div2(
      ...
      tosiScrollCamera(
        ...
        tosiWaypoint({ progress: 0.5, alpha: 0, beta: 1, radius: 70 }),
...
Companion components \`<tosi-scroll-time>\` (skybox time-of-day) and \`<tosi-scroll-animation>\` (named AnimationGroups) plug into the same scene.`),
  ...
  md(`## \`section.scrollCallback\` — custom integrations
...
Override \`app.themeTarget\` if you'd rather scope theme vars to a different element (e.g. the engine itself when nested).`),
  tosiProductSection(
    ...
    div2(
      { class: "scene" },
      h22("Paper"),
      p3("Light theme settled. The chrome above and below switched too."),
  ...
  div2(
    ...
    div2(
      ...
      tosiProduct(
        ...["Hero", "Intro", "Reveal", "Theme", "Done"].map((label, i3, arr) =>
          tosiProductSection(
            {
              scroll: 80,
