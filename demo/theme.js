...
var app = tosiProduct(
  ...
  tosiProductSection(
    ...
    div2(
      { class: "scene" },
      h2("Paper"),
      p2("Light theme settled. Sticky header is themed in light too."),
  ...
  tosiProductSection(
    ...
    div2(
      { class: "scene" },
      h2("Dusk"),
      p2("And back the other way — paper interpolating to rose."),
  ...
  tosiProductSection(
    ...
    div2(
      { class: "scene" },
      h2("Rose"),
      p2("Last section. The footer below inherits this theme too."),
...
var pageFooter = footer(
  { class: "page-footer" },
  p2("Page footer — themed by whatever section ended the engine.")
);
