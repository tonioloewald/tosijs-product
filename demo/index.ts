...
const app = tosiProduct(
  ...
  tosiProductSection(
    ...
    tosiInterpolator(
      ...
      tosiWaypoint({
        progress: 0.0,
        style: { transform: "translate(0vw, 0vh) scale(1.0)", opacity: 0.2 },
      }),
      tosiWaypoint({
        progress: 0.5,
        style: { transform: "translate(30vw, 30vh) scale(3.0)", opacity: 1.0 },
      }),
      tosiWaypoint({
        progress: 1.0,
        style: {
    ...
    tosiInterpolator(
      ...
      tosiWaypoint({
        progress: 0.0,
        style: { transform: "translate(0vw, 0vh) scale(0.1)", opacity: 1.0 },
      }),
      tosiWaypoint({
        progress: 0.5,
        style: { transform: "translate(0vw, 0vh) scale(1.5)", opacity: 0.8 },
      }),
      tosiWaypoint({
        progress: 1.0,
        style: { transform: "translate(0vw, 0vh) scale(5.0)", opacity: 0 },
      }),
      elements.img({
        src: "https://tosijs.net/favicon.svg",
        style: {
    ...
    overlay("0.1, 0.4", "Dynamic multi-layer interpolation", {
      style: { color: "#000" },
    }),
